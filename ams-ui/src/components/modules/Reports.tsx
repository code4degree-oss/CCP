    ...
    try {
      ...
      const excelData = fullData.map((a: any) => {
        ...
        return {
          ...
          'APAAR ID': demo.apaar_id || '-',
          'Religion': demo.religion || '-',
          'Mother Tongue': demo.mother_tongue || '-',
          'Nationality': demo.nationality || '-',
          'Region Classification': demo.region_of_residence || '-',
          'Parent Mobile': demo.alternate_mobile || details.alternate_mobile || '-',

          // Permanent Address
          'Address Line 1': demo.address_line1 || '-',
          'Address Line 2': demo.address_line2 || '-',
          'Address Line 3': demo.address_line3 || '-',
          ...
          // Present Address
          'Addresses Different': demo.addresses_different ? 'YES' : 'NO',
          'Present Address Line 1': demo.present_address_line1 || '-',
          'Present Address Line 2': demo.present_address_line2 || '-',
          'Present Address Line 3': demo.present_address_line3 || '-',
          'Present Village': demo.present_village || '-',
          'Present City': demo.present_city || '-',
          'Present Taluka': demo.present_taluka || '-',
          'Present District': demo.present_district || '-',
          'Present State': demo.present_state || '-',
          'Present Pincode': demo.present_pincode || '-',

          // MHT-CET
          'CET Roll No': acad.cet_roll_no || '-',
          'CET Application No': acad.cet_application_no || '-',
          'CET Score': acad.cet_score || '-',
          'CET DOB': acad.cet_dob || '-',
          ...
          'SSC Maths': acad.ssc_maths || '-',
          'SSC Science': acad.ssc_science || '-',
          'SSC English': acad.ssc_english || '-',

          // Academic HSC
          'HSC Name': acad.hsc_name || '-',
          'HSC Mother Name': acad.hsc_mother_name || '-',
          'HSC Exam Status': acad.hsc_exam_status || '-',
          ...
          'Highest Marks Subject': acad.highest_marks_subject || '-',
          ...
          'Selected Minority': demo.selected_minority || '-',
          'Claim Linguistic Minority': demo.claim_linguistic_minority || '-',
          'Selected Linguistic Minority': demo.selected_linguistic_minority || '-',

          // Certificate Document Status
          'Caste Cert Status': demo.caste_cert_status || '-',
          'Caste Cert Doc No': demo.caste_cert_doc_no || '-',
          'Caste Cert Issue Date': demo.caste_cert_issue_date || '-',
          'Caste Cert District': demo.caste_cert_district || '-',
          'Caste Validity Status': demo.caste_validity_status || '-',
          'Caste Validity Doc No': demo.caste_validity_doc_no || '-',
          'Caste Validity Issue Date': demo.caste_validity_issue_date || '-',
          'Caste Validity District': demo.caste_validity_district || '-',
          'NCL Cert Status': demo.ncl_cert_status || '-',
          'NCL Cert Doc No': demo.ncl_cert_doc_no || '-',
          'NCL Cert Issue Date': demo.ncl_cert_issue_date || '-',
          'NCL Cert District': demo.ncl_cert_district || '-',
          'EWS Cert Status': demo.ews_cert_status || '-',
          'EWS Cert Doc No': demo.ews_cert_doc_no || '-',
          'EWS Cert Issue Date': demo.ews_cert_issue_date || '-',
          'EWS Cert District': demo.ews_cert_district || '-',
