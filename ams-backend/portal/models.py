...
class Enquiry(models.Model):
    ...
    jee_application_no = models.CharField(max_length=30, blank=True, null=True)
    jee_expected_marks = models.SmallIntegerField(blank=True, null=True)
    mht_cet_pcm_application_no = models.CharField(max_length=30, blank=True, null=True)
    mht_cet_pcm_expected_marks = models.SmallIntegerField(blank=True, null=True)
    mht_cet_pcb_application_no = models.CharField(max_length=30, blank=True, null=True)
    mht_cet_pcb_expected_marks = models.SmallIntegerField(blank=True, null=True)
